...
function areaChangeDisplay(item){if(item.status!=='普查完成')return '<span class="area-flat">—</span>';return hasAreaChange(item)?'<span class="tag tag-red">是</span>':'<span class="tag tag-green">否</span>';}
