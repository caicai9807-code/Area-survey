...
const OUTPLAN_REASONS={area:'面积变化',direct:'一管到户（自管站）',new:'新开户',gas:'燃气替代'};
...
const OUTPLAN_SEED=[
 {id:'OP20260715001',name:'桥西管理部面积变化专项普查',reason:'area',start:'2026-07-16T09:00',end:'2026-07-30T18:00',stationIds:['s01','s02'],status:'待分配',creator:'王建国',creatorRole:'管理部',createdAt:'2026-07-15 09:18:20',logs:[{action:'下发任务',operator:'王建国',time:'2026-07-15 09:25:10',detail:'任务已下发至桥西片区所、振头片区所'},{action:'创建任务',operator:'王建国',time:'2026-07-15 09:18:20',detail:'创建计划外普查任务'}]},
 {id:'OP20260714002',name:'新开户面积确认任务',reason:'new',start:'2026-07-15T08:30',end:'2026-07-25T17:30',stationIds:['s03'],status:'进行中',creator:'业务管理员',creatorRole:'业务管理员',createdAt:'2026-07-14 14:06:33',logs:[{action:'分配人员',operator:'桥西片区所',time:'2026-07-15 08:40:00',detail:'已分配普查人员张三'},{action:'下发任务',operator:'业务管理员',time:'2026-07-14 14:10:00',detail:'任务已下发'}]},
 {id:'OP20260712003',name:'燃气替代专项普查',reason:'gas',start:'2026-07-12T09:00',end:'2026-07-22T18:00',stationIds:['s04'],status:'所长审核',creator:'业务管理员',creatorRole:'业务管理员',createdAt:'2026-07-12 08:50:16',logs:[{action:'提交审核',operator:'张三',time:'2026-07-14 16:20:00',detail:'普查结果已提交片区所审核'}]},
 {id:'OP20260701004',name:'自管站一管到户普查',reason:'direct',start:'2026-07-01T09:00',end:'2026-07-12T18:00',stationIds:['s05'],status:'已完成',creator:'长安管理部',creatorRole:'管理部',createdAt:'2026-07-01 09:00:00',logs:[{action:'审核完成',operator:'长安管理部',time:'2026-07-11 15:30:00',detail:'管理部审核通过，任务完成'}]},
 {id:'OP20260715005',name:'裕华新开户临时普查',reason:'new',start:'2026-07-18T09:00',end:'2026-07-31T18:00',stationIds:['s07','s08'],status:'未下发',creator:'业务管理员',creatorRole:'业务管理员',createdAt:'2026-07-15 11:10:08',logs:[{action:'创建任务',operator:'业务管理员',time:'2026-07-15 11:10:08',detail:'任务保存为未下发'}]}
];
const OUTPLAN_STATION_IDS=new Set(OUTPLAN_STATIONS.map(item=>item.id));
function outPlanNormalizeTasks(tasks){return (Array.isArray(tasks)?tasks:[]).map(item=>{const {reasonSubtype,...task}=item;return {...task,stationIds:(task.stationIds||[]).filter(id=>OUTPLAN_STATION_IDS.has(id)),logs:[...(task.logs||[])]};}).filter(item=>item.stationIds.length);}
...
function outPlanReason(task){return OUTPLAN_REASONS[task.reason]||'待确认';}
