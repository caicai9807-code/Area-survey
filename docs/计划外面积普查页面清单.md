...
| OP-02 | 新建/编辑计划外任务 | `area-survey-outplan-create.html` | 业务管理员/管理部 | 部分实现 | 主任务列表/详情 → 主任务列表；待按新口径增加原因化对象规则 |
...
| OP-05 | 趸售用户站普查填报 | `area-survey-wholesale-fill.html` | 普查人员 | 已实现 | 计划外执行列表（趸售用户）→ 项目新增/复制/项目填报/上报 |
